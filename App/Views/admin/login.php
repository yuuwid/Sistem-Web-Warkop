    ...
    <div class="card w-50 mx-auto p-4 shadow rounded rounded-3">
        ...
        <form method="POST" action="<?= URL ?>/admin/login">
            <div class="mb-3">
                ...
                <input name="notelp" type="text" class="form-control" id="inputnotelp" required value="083456789012">
            </div>

            <div class="mb-3">
                <label for="inputNIK" class="form-label">NIK</label>
                <input name="nik" type="password" class="form-control" id="inputNIK" required value="567821">
            </div>
