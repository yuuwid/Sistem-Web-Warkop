<div class="container my-4">
    ...
    <div class="col-6 ms-auto">
        <div class="input-group mb-3">
            ...
            <button class="btn btn-success ms-2" type="button" data-bs-toggle="modal" data-bs-target="#modalPegawai" onclick="tambah()"><i class="bi bi-plus-lg"></i></button>
        </div>
    </div>

    <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3" id="data-pegawai">
            ...
            <div class="modal-body">
                <div class="row row-cols-1 row-cols-lg-2">
                    <div class="col">
                        ...
                        <div class="mb-3">
                            <label for="namaInput" class="form-label fw-bold">NIP pegawai</label>
                            <div class="input-group mb-3">
                        ...
                        <div class="mb-3">
                            <label for="namaInput" class="form-label fw-bold">No Telepon Pegawai</label>
                            <div class="input-group mb-3">
